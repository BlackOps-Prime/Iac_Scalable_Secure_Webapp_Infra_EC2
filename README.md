...
The architecture is designed with resiliency in mind. It makes use of Multi-AZs for repliaction, autoscalling for scaling and loadbalancing for load management.
